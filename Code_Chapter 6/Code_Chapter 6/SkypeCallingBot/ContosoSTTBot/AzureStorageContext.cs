...
namespace ContosoSTTBot
{
    public class AzureStorageContext
    {
        ...
        public async Task<TableResult> SaveCallStateAsync(CallState callState)
        {
            ...
            CloudTable table = tableClient.GetTableReference("contosouservoicewithtext");

            // Create the table if it doesn't exist.
            table.CreateIfNotExists();

            CallStateTableEntity callStateTableEntity = new CallStateTableEntity(callState.Id);
            ...
            callStateTableEntity.SpeechToTextPhrase = callState.SpeechToTextPhrase;
    ...
    public class CallStateTableEntity : TableEntity
    {
        ...
        /// Initializes a new instance of the <see cref="CallStateTableEntity"/> class.
        /// </summary>
        /// <param name="conversationId">The participant identifier.</param>
        public CallStateTableEntity(string conversationId)
        {
